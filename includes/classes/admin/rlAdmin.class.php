...
class rlAdmin
{
    ...
    public function deleteTrashItem($id = 0)
    {
        ...
        global $rlDb, $rlCategories, $rlListings, $reefless, $rlDebug, $config;
        ...
        switch ($removedEntity) {
            ...
            case 'categories':
                ...
                if ($cat_info['ID']) {
                    ...
                    $rlDb->query("DELETE FROM `{db_prefix}categories` WHERE `ID` = {$cat_info['ID']} LIMIT 1");
                }
                break;
     ...
     * @package xAjax
     *
     * @param string $ids     - listings ids, ex: 250,388,501,...
    ...
    {
        global $config, $lang, $rlSmarty, $reefless, $_response, $rlDb;
    ...
    {
        global $config, $lang, $reefless, $_response, $rlDb;
