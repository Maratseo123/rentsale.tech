...
<ul class="tabs">
    <li lang="report" class="active">{$lang.rbl_report}</li>
    <li lang="listing">{$lang.rbl_listing_detail}</li>
</ul>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                reportDetailGrid = new gridObj({
                    ...
                    title: rblLang['rbl_report_message'],
                    filters: filter,
                    fields: [
                    ...
                    columns: [{
                        ...
                        header: rblLang['rbl_report_message'],
                        dataIndex: 'Message',
                        ...
                        header: rblLang['rbl_report_date'],
                        dataIndex: 'Date',
                        width: 120,
                        fixed: true,
                        id: 'rlExt_badword_value',
                        ...
                        header: rblLang['rbl_ip'],
                        dataIndex: 'IP',
                        width: 100,
                        fixed: true,
                        id: 'rbl_ip_value'
                    }, {
                        header: rblLang['rbl_criticality'],
                        dataIndex: 'Criticality',
                        width: 100,
                        fixed: true,
                        renderer: function (val, param1) {
                            var phrase = rblLang['rbl_criticality_low'];

                            if (val > 30 && val < 80) {
                                phrase = rblLang['rbl_criticality_medium'];
                                param1.style += 'background: #ffe7ad;';
                            } else if (val >= 80) {
                                phrase = rblLang['rbl_criticality_high'];
                        ...
                        renderer: function (id, obj, row) {
                            return "<center><img class='remove' ext:qtip='" + lang['ext_reportbroken_delete'] + "' src='" + rlUrlHome + "img/blank.gif' onClick='rlPrompt( \"" + lang['ext_notice_' + delete_mod] + "\",  \"report.deleteReport\", \"" + row.data.ID + "\")' /></center>";
                        }
                    }
                    ]
                });
