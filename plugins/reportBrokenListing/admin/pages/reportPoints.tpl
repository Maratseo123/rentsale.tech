    ...
    $(document).ready(function () {
        reportPointsGrid = new gridObj({
            ...
            columns: [{
                ...
                header: rblLang['rbl_points_to_inactive'],
                ...
                renderer: function (id, obj, row) {
                    ...
                    out += "<img class='remove' ext:qtip='" + lang['ext_reportbroken_delete'] + "' src='" + rlUrlHome + "img/blank.gif' onClick='rlConfirm( \"" + lang['ext_notice_' + delete_mod] + "\",  \"reportPoints.deletePoint\", \"" + row.data.Key + "\")' /></center>";
                    return out;
                }
            }
            ]
