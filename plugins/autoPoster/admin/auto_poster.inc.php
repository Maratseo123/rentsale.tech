    ...
    if ($_GET['module']) {
        ...
        if (key_exists($module, $available_modules)) {
            ...
            if ($_POST['submit']) {
                ...
                if ($module == 'facebook' && $autoPostingModules->isConfigurationChanged($configs, $module)) {
                    $facebook = (new \Autoposter\ProviderController($module))->getProvider();
                    $facebook->removeToken(1);
                }
