...
class rlHybridAuthLogin
{
    ...
    {
        // todo: add excepting of provided storage keys
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS `" . RL_DBPREFIX . "ha_uids` (
        ...
        $sql = "CREATE TABLE IF NOT EXISTS `" . RL_DBPREFIX . "ha_providers` (
                  `ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
                  `Provider` varchar(50) DEFAULT NULL,
    ...
    {
        $this->rlDb->query("DROP TABLE IF EXISTS `" . RL_DBPREFIX . "ha_uids`");
        $this->rlDb->query("DROP TABLE IF EXISTS `" . RL_DBPREFIX . "ha_providers`");
    }
