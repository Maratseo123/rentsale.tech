<?php /* Smarty version 2.6.31, created on 2023-10-31 14:13:49
                ...
                <td class="field">
                    <label>
                        <input type="radio"
                               ...
                               value="1"
                               class="translate"
                               <?php if (! $this->_tpl_vars['config']['google_translation_api_key']): ?> disabled class="disabled"<?php endif; ?> /> <?php echo $this->_tpl_vars['lang']['yes']; ?>
                    ...
                    <label>
                        <input checked="checked"
                               ...
                               value="0"
                               class="translate"
                               <?php if (! $this->_tpl_vars['config']['google_translation_api_key']): ?> disabled class="disabled"<?php endif; ?> /> <?php echo $this->_tpl_vars['lang']['no']; ?>

                    </label>

                    <?php if (! $this->_tpl_vars['config']['google_translation_api_key']): ?>
