<?php /* Smarty version 2.6.31, created on 2023-10-31 15:35:19
         compiled from controllers/listing_types.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'rlHook', 'controllers/listing_types.tpl', 5, false),array('modifier', 'cat', 'controllers/listing_types.tpl', 19, false),array('modifier', 'count', 'controllers/listing_types.tpl', 38, false),array('modifier', 'regex_replace', 'controllers/listing_types.tpl', 116, false),array('modifier', 'replace', 'controllers/listing_types.tpl', 221, false),array('modifier', 'in_array', 'controllers/listing_types.tpl', 537, false),array('modifier', 'ceil', 'controllers/listing_types.tpl', 544, false),array('modifier', 'explode', 'controllers/listing_types.tpl', 987, false),)), $this); ?>
<!-- listing types tpl -->
...
"
            ...
            <tr>
                <td class="name"><?php echo $this->_tpl_vars['lang']['category_box_type_page_position']; ?>
</td>
                <td class="field">
                    <select name="cat_position">
                        <?php $_from = $this->_tpl_vars['cat_positions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['sKey'] => $this->_tpl_vars['block_side']):
?>
                        <option value="<?php echo $this->_tpl_vars['sKey']; ?>
" <?php if ($this->_tpl_vars['sKey'] == $this->_tpl_vars['sPost']['cat_position'] || ( ! $this->_tpl_vars['sPost']['cat_position'] && $this->_tpl_vars['sKey'] == 'hide' )): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['block_side']; ?>
</option>
                        <?php endforeach; endif; unset($_from); ?>
                    </select>
                </td>
            ...
            <tr>
                <td class="name"><?php echo $this->_tpl_vars['lang']['display_counter']; ?>
</td>
                <td class="field">
                    <?php $this->assign('checkbox_field', 'display_counter'); ?>
                    ...
                    <input <?php echo $this->_tpl_vars['display_counter_yes']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="1" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes"><?php echo $this->_tpl_vars['lang']['yes']; ?>
</label>
                    <input <?php echo $this->_tpl_vars['display_counter_no']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="0" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no"><?php echo $this->_tpl_vars['lang']['no']; ?>
...
_no"><?php echo $this->_tpl_vars['lang']['no']; ?>
            ...
            <tr>
                <td class="name"><?php echo $this->_tpl_vars['lang']['display_subcategories']; ?>
</td>
                <td class="field">
                    <?php $this->assign('checkbox_field', 'display_subcategories'); ?>
                    ...
                    <input <?php echo $this->_tpl_vars['display_subcategories_yes']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="1" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes"><?php echo $this->_tpl_vars['lang']['yes']; ?>
</label>
                    <input <?php echo $this->_tpl_vars['display_subcategories_no']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="0" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no"><?php echo $this->_tpl_vars['lang']['no']; ?>
            ...
            <table class="form" style="margin-top: 5px;">
            <tr>
                <td class="divider" colspan="3"><div class="inner"><?php echo $this->_tpl_vars['lang']['additional_cat_block']; ?>
</div></td>
            </tr>
            <tr>
                ...
                <td class="field">
                    <?php $this->assign('bPages', $this->_tpl_vars['sPost']['ablock_pages']); ?>
...
?>
                            ...
                            <div style="padding: 2px 8px 2px 0;">
                                <input class="checkbox"
                                       <?php if ($this->_tpl_vars['bPages'] && ((is_array($_tmp=$this->_tpl_vars['pId'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['bPages']) : in_array($_tmp, $this->_tpl_vars['bPages']))): ?>checked="checked"<?php endif; ?>
                                       id="page_<?php echo $this->_tpl_vars['page']['ID']; ?>
"
                                       type="checkbox"
                                       name="ablock_pages[<?php echo $this->_tpl_vars['page']['ID']; ?>
]"
...
"><?php echo $this->_tpl_vars['page']['name']; ?>
            ...
            <tr>
                <td class="name"><span class="red hide position_star">*</span><?php echo $this->_tpl_vars['lang']['position']; ?>
</td>
                <td class="field">
    ...
    foreach ($_from as $this->_tpl_vars['sKey'] => $this->_tpl_vars['block_side']):
?>
                        <?php if ($this->_tpl_vars['sKey'] == 'hide'): ?><?php continue; ?><?php endif; ?>
                        <option value="<?php echo $this->_tpl_vars['sKey']; ?>
" <?php if ($this->_tpl_vars['sKey'] == $this->_tpl_vars['sPost']['ablock_position']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['block_side']; ?>
</option>
                        <?php endforeach; endif; unset($_from); ?>
                    </select>

                    <?php if ($_GET['action'] == 'edit' && ! empty ( $this->_tpl_vars['sPost']['ablock_pages']['0'] )): ?>
                        <?php $this->assign('replace', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp='<a target="_blank" class="static" href="')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['rlBase']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['rlBase'])))) ? $this->_run_mod_handler('cat', true, $_tmp, 'index.php?controller=blocks&amp;action=edit&amp;block=ltcb_') : smarty_modifier_cat($_tmp, 'index.php?controller=blocks&amp;action=edit&amp;block=ltcb_')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['key']) : smarty_modifier_cat($_tmp, $_GET['key'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">$1</a>') : smarty_modifier_cat($_tmp, '">$1</a>'))); ?>
                        <span class="field_description"><?php echo ((is_array($_tmp=$this->_tpl_vars['lang']['show_on_pages_hint'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, '/\[(.*)\]/', $this->_tpl_vars['replace']) : smarty_modifier_regex_replace($_tmp, '/\[(.*)\]/', $this->_tpl_vars['replace'])); ?>
</span>
                    <?php endif; ?>
                </td>
            </tr>
            ...
            <tr>
                <td class="name"><?php echo $this->_tpl_vars['lang']['display_first']; ?>
</td>
                <td class="field">
                    <input style="width: 30px;" type="text" class="numeric" name="ablock_visible_number" value="<?php echo $this->_tpl_vars['sPost']['ablock_visible_number']; ?>
" />
                    <span class="field_description"><?php echo $this->_tpl_vars['lang']['display_first_hint']; ?>
</span>
                </td>
            </tr>

            <tr>
                <td class="name"><?php echo $this->_tpl_vars['lang']['category_scrolling_in_box']; ?>
</td>
                <td class="field">
                    <?php $this->assign('checkbox_field', 'ablock_scrolling_in_box'); ?>
                    ...
                    <input <?php echo $this->_tpl_vars['ablock_scrolling_in_box_yes']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="1" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes"><?php echo $this->_tpl_vars['lang']['yes']; ?>
</label>
                    <input <?php echo $this->_tpl_vars['ablock_scrolling_in_box_no']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="0" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no"><?php echo $this->_tpl_vars['lang']['no']; ?>
            ...
            <tr>
                ...
                <td class="field">
                    <?php $this->assign('checkbox_field', 'ablock_display_subcategories'); ?>
                    ...
                    <input <?php echo $this->_tpl_vars['ablock_display_subcategories_yes']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="1" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_yes"><?php echo $this->_tpl_vars['lang']['yes']; ?>
</label>
                    <input <?php echo $this->_tpl_vars['ablock_display_subcategories_no']; ?>
 type="radio" id="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no" name="<?php echo $this->_tpl_vars['checkbox_field']; ?>
" value="0" /> <label for="<?php echo $this->_tpl_vars['checkbox_field']; ?>
_no"><?php echo $this->_tpl_vars['lang']['no']; ?>
            ...
            <tr>
                <td class="name"><?php echo $this->_tpl_vars['lang']['ablock_subcats_number']; ?>
</td>
                <td class="field">
                    <input style="width: 30px;" type="text" class="numeric" name="ablock_subcategories_number" value="<?php echo $this->_tpl_vars['sPost']['ablock_subcategories_number']; ?>
" />
                    <span class="field_description"><?php echo $this->_tpl_vars['lang']['display_first_subcats_hint']; ?>
</span>
                </td>
            </tr>
