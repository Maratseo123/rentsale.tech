<?php /* Smarty version 2.6.31, created on 2023-10-31 15:48:45
         compiled from controllers/blocks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'rlHook', 'controllers/blocks.tpl', 5, false),array('function', 'fckEditor', 'controllers/blocks.tpl', 122, false),array('modifier', 'strpos', 'controllers/blocks.tpl', 21, false),array('modifier', 'cat', 'controllers/blocks.tpl', 26, false),array('modifier', 'count', 'controllers/blocks.tpl', 46, false),array('modifier', 'ceil', 'controllers/blocks.tpl', 151, false),array('modifier', 'json_encode', 'controllers/blocks.tpl', 318, false),)), $this); ?>
<!-- blocks tpl -->
...
<?php if ($_GET['action']): ?>
    <?php $this->assign('sPost', $_POST); ?>
        ...
        <?php if (((is_array($_tmp=$this->_tpl_vars['block']['Key'])) ? $this->_run_mod_handler('strpos', true, $_tmp, 'ltsb_') : strpos($_tmp, 'ltsb_')) === 0 || $this->_tpl_vars['block']['Key'] === 'my_profile_sidebar'): ?>
