<?php /* Smarty version 2.6.31, created on 2023-10-29 16:08:47
         compiled from /var/www/u2273289/data/www/heidenbauer.ru/plugins/multiField/mfield.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'in_array', '/var/www/u2273289/data/www/heidenbauer.ru/plugins/multiField/mfield.tpl', 1, false),array('modifier', 'regex_replace', '/var/www/u2273289/data/www/heidenbauer.ru/plugins/multiField/mfield.tpl', 3, false),array('modifier', 'cat', '/var/www/u2273289/data/www/heidenbauer.ru/plugins/multiField/mfield.tpl', 5, false),)), $this); ?>
...
');
        ...
        <?php if ($_POST[$this->_tpl_vars['mf_form_prefix']][$this->_tpl_vars['field_key']]): ?>
            mfFieldVals['<?php echo $this->_tpl_vars['head_field_key']; ?>
']['<?php echo $this->_tpl_vars['field_key']; ?>
'] = '<?php echo $_POST[$this->_tpl_vars['mf_form_prefix']][$this->_tpl_vars['field_key']]; ?>
';
            <?php $this->assign('mf_data_source', 'post'); ?>
        <?php elseif ($_POST[$this->_tpl_vars['field_key']]): ?>
            mfFieldVals['<?php echo $this->_tpl_vars['head_field_key']; ?>
']['<?php echo $this->_tpl_vars['field_key']; ?>
'] = '<?php echo $_POST[$this->_tpl_vars['field_key']]; ?>
';
            <?php $this->assign('mf_data_source', 'post'); ?>
