<?php /* Smarty version 2.6.31, created on 2023-11-09 02:12:46
         compiled from controllers/custom_categories.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'rlHook', 'controllers/custom_categories.tpl', 104, false),)), $this); ?>
<!-- custom categories tpl -->

<?php if ($this->_tpl_vars['allow_tmp']): ?>
    <!-- categories grid -->
    <div id="grid"></div>
    ...
    $(document).ready(function(){
        ...
        '; ?>
<?php echo $this->_plugins['function']['rlHook'][0][0]->load(array('name' => 'apTplCustomCategoriesGrid'), $this);?>
<?php echo '
    ...
    <?php echo $this->_plugins['function']['rlHook'][0][0]->load(array('name' => 'apTplCustomCategoriesBottom'), $this);?>
