<?php /* Smarty version 2.6.31, created on 2023-11-05 21:59:52
         compiled from controllers/browse.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'rlHook', 'controllers/browse.tpl', 7, false),array('modifier', 'cat', 'controllers/browse.tpl', 33, false),array('modifier', 'is_array', 'controllers/browse.tpl', 197, false),array('modifier', 'in_array', 'controllers/browse.tpl', 420, false),)), $this); ?>
<!-- listings tpl -->
...
<?php endif; ?></a>
                        ...
                        <?php if (! empty ( $this->_tpl_vars['cat']['sub_categories'] ) && $this->_tpl_vars['listing_types'][$this->_tpl_vars['category']['Type']]['Cat_show_subcats']): ?>
...
<?php endif; ?></a>
                                                                        ...
                                                                        <?php if (! empty ( $this->_tpl_vars['cat']['sub_categories'] ) && $this->_tpl_vars['listing_types'][$this->_tpl_vars['section']['Key']]['Cat_show_subcats']): ?>
                                    <div class="sub_categories">
                                        <?php $_from = $this->_tpl_vars['cat']['sub_categories']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['subCatF'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['subCatF']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['sub_cat']):
