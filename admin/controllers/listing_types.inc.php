                ...
                if ($_GET['action'] == 'add') {
                    ...
                    if ($action = $rlDb->insertOne($data, 'listing_types')) {
                        ...
                        if (!empty($_POST['ablock_pages'])) {
                            ...
                            $rlDb->insertOne($category_block, 'blocks');
                        }
                    ...
                    $rlDb->updateOne($cat_block, 'blocks');
                    ...
                    if (!$rlDb->getOne('ID', "`Key` = 'lt_{$p_key}'", 'pages')) {
                        ...
                        $rlDb->insertOne($category_insert, 'categories');
                    ...
                    // my ads box tracker
                    $suspend = ((int) $type_info[$ma_form_field] && !(int) $_POST[strtolower($ma_form_field)]);
                    ...
                    $suspend = ((int) $type_info['Search_type'] && !(int) $_POST[strtolower('Search_type')]);
                    $rlListingTypes->apBlocksTracker(array(
                        'key'              => $p_key,
                        'prefix'           => 'ltpb_',
                        'page_ids'         => $page_id,
