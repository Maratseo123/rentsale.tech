                ...
                <td class="field">
                    <label>
                        <input type="radio"
                               ...
                               value="1"
                               class="translate"
                               {if !$config.google_translation_api_key} disabled class="disabled"{/if} /> {$lang.yes}
                    </label>
                    <label>
                        <input checked="checked"
                               ...
                               value="0"
                               class="translate"
                               {if !$config.google_translation_api_key} disabled class="disabled"{/if} /> {$lang.no}
                    </label>

                    {if !$config.google_translation_api_key}
